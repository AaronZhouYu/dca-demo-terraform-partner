...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.3_L1_Ensure_Access_this_computer_from_the_network__is_set_to_Administrators_Authenticated_Users_MS_only" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.7_L1_Ensure_Allow_log_on_locally_is_set_to_Administrators" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.9_L1_Ensure_Allow_log_on_through_Remote_Desktop_Services_is_set_to_Administrators_Remote_Desktop_Users_MS_only" do
  ...
  describe security_policy.SeRemoteInteractiveLogonRight do
    it { should match_array permitted_principals }
  end
end

control "xccdf_org.cisecurity.benchmarks_rule_2.2.10_L1_Ensure_Back_up_files_and_directories_is_set_to_Administrators" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.11_L1_Ensure_Change_the_system_time_is_set_to_Administrators_LOCAL_SERVICE" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.12_L1_Ensure_Change_the_time_zone_is_set_to_Administrators_LOCAL_SERVICE" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.13_L1_Ensure_Create_a_pagefile_is_set_to_Administrators" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.14_L1_Ensure_Create_a_token_object_is_set_to_No_One" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.15_L1_Ensure_Create_global_objects_is_set_to_Administrators_LOCAL_SERVICE_NETWORK_SERVICE_SERVICE" do
  ...
  describe security_policy.SeCreateGlobalPrivilege do
    it { should match_array permitted_principals }
  end
end

control "xccdf_org.cisecurity.benchmarks_rule_2.2.16_L1_Ensure_Create_permanent_shared_objects_is_set_to_No_One" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.18_L1_Ensure_Create_symbolic_links_is_set_to_Administrators_NT_VIRTUAL_MACHINEVirtual_Machines_MS_only" do
  ...
  impact 1.0
  tag cce: "CCE-35823-4"
  if powershell('c:\windows\system32\Dism /online /Get-FeatureInfo /FeatureName:Microsoft-Hyper-V').stdout.strip  =~ /^State : Enabled/
    describe security_policy.SeCreateSymbolicLinkPrivilege do
      it { should match_array ["S-1-5-32-544", "S-1-5-83-0"] }
    end
  else
    describe security_policy.SeCreateSymbolicLinkPrivilege do
      it { should match_array ["S-1-5-32-544"] }
    end
  end
end
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.21_L1_Ensure_Deny_access_to_this_computer_from_the_network_to_include_Guests_Local_account_and_member_of_Administrators_group_MS_only" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.23_L1_Ensure_Deny_log_on_as_a_service_to_include_Guests" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.24_L1_Ensure_Deny_log_on_locally_to_include_Guests" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.28_L1_Ensure_Enable_computer_and_user_accounts_to_be_trusted_for_delegation_is_set_to_No_One_MS_only" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.29_L1_Ensure_Force_shutdown_from_a_remote_system_is_set_to_Administrators" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.32_L1_Ensure_Impersonate_a_client_after_authentication_is_set_to_Administrators_LOCAL_SERVICE_NETWORK_SERVICE_SERVICE_and_when_the_Web_Server_IIS_Role_with_Web_Services_Role_Service_is_installed_IIS_IUSRS_MS_only" do
  ...
  impact 1.0
  tag cce: "CCE-37106-2"
  if powershell('c:\windows\system32\Dism /online /Get-FeatureInfo /FeatureName:IIS-WebServer').stdout.strip  =~ /^State : Enabled/
    describe security_policy.SeImpersonatePrivilege do
      it { should match_array ["S-1-5-32-544", "S-1-5-19", "S-1-5-20", "S-1-5-6", "S-1-5-32-568"] }
    end
  else
    describe security_policy.SeImpersonatePrivilege do
      it { should match_array ["S-1-5-32-544", "S-1-5-19", "S-1-5-20", "S-1-5-6"] }
    end
  end
end

control "xccdf_org.cisecurity.benchmarks_rule_2.2.33_L1_Ensure_Increase_scheduling_priority_is_set_to_Administrators_Window_ManagerWindow_Manager_Group" do
  title "(L1) Ensure 'Increase scheduling priority' is set to 'Administrators, Window Manager\\Window Manager Group'"
  desc  "
  ...
  impact 1.0
  tag cce: "CCE-38326-5"
  permitted_principals = ["S-1-5-32-544", "S-1-5-90-0"]
  describe security_policy.SeIncreaseBasePriorityPrivilege do
    it { should match_array permitted_principals }
  end
end

control "xccdf_org.cisecurity.benchmarks_rule_2.2.34_L1_Ensure_Load_and_unload_device_drivers_is_set_to_Administrators" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.35_L1_Ensure_Lock_pages_in_memory_is_set_to_No_One" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.38_L1_Ensure_Manage_auditing_and_security_log_is_set_to_Administrators_MS_only" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.39_L1_Ensure_Modify_an_object_label_is_set_to_No_One" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.40_L1_Ensure_Modify_firmware_environment_values_is_set_to_Administrators" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.41_L1_Ensure_Perform_volume_maintenance_tasks_is_set_to_Administrators" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.42_L1_Ensure_Profile_single_process_is_set_to_Administrators" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.43_L1_Ensure_Profile_system_performance_is_set_to_Administrators_NT_SERVICEWdiServiceHost" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.44_L1_Ensure_Replace_a_process_level_token_is_set_to_LOCAL_SERVICE_NETWORK_SERVICE" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.45_L1_Ensure_Restore_files_and_directories_is_set_to_Administrators" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.2.46_L1_Ensure_Shut_down_the_system_is_set_to_Administrators" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.1.5_L1_Configure_Accounts_Rename_administrator_account" do
  ...
  impact 1.0
  tag cce: "CCE-38233-3"
  machine_sid = powershell('"{0}-500" -f [System.Security.Principal.WindowsIdentity]::GetCurrent().User.AccountDomainSid').stdout.strip.gsub(/^S-1-5-21-/, '').gsub(/-[0-9]+$/, '')
  user_sid = "S-1-5-21-#{machine_sid}-500"
  describe powershell("Get-WmiObject -Class win32_useraccount -filter \"Domain='\$(\$env:ComputerName)' and SID='#{user_sid}'\" | Format-Table Name -HideTableHeaders").stdout.strip.upcase do
    it { should_not eq "ADMINISTRATOR" }
  end
end
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.7.1_L1_Ensure_Interactive_logon_Do_not_require_CTRLALTDEL_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.7.2_L1_Ensure_Interactive_logon_Dont_display_last_signed-in_is_set_to_Enabled" do
  title "(L1) Ensure 'Interactive logon: Don't display last signed-in' is set to 'Enabled'"
  desc  "
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.7.6_L2_Ensure_Interactive_logon_Number_of_previous_logons_to_cache_in_case_domain_controller_is_not_available_is_set_to_4_or_fewer_logons_MS_only" do
  ...
  describe registry_key("HKEY_LOCAL_MACHINE\\Software\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon") do
    ...
    its("CachedLogonsCount") { should match(/^[43210]$/) }
  end
end
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.9.1_L1_Ensure_Microsoft_network_server_Amount_of_idle_time_required_before_suspending_session_is_set_to_15_or_fewer_minutes" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.10.4_L2_Ensure_Network_access_Do_not_allow_storage_of_passwords_and_credentials_for_network_authentication_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.10.7_L1_Configure_Network_access_Named_Pipes_that_can_be_accessed_anonymously_MS_only" do
  ...
  tag cce: "CCE-38258-0"
  expected = [""]
  if command('((Get-Service -DisplayName "Computer Browser" -ErrorAction SilentlyContinue).Status -eq "Running") -and ([bool](Get-Command C:\windows\System32\browser.dll -ErrorAction SilentlyContinue))').stdout.match("True")
    expected = ["BROWSER"]
  end
  reg_values = registry_key("HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\LanManServer\\Parameters").NullSessionPipes
  unless reg_values.nil?
    describe(reg_values.sort) do
      it { should eq expected.sort }
    end
  else
    describe reg_values do
      it { should_not be_nil }
    end
  end
end

control "xccdf_org.cisecurity.benchmarks_rule_2.3.10.8_L1_Configure_Network_access_Remotely_accessible_registry_paths" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.10.9_L1_Configure_Network_access_Remotely_accessible_registry_paths_and_sub-paths" do
  ...
  impact 1.0
  tag cce: "CCE-36347-3"
  expected = ["System\\CurrentControlSet\\Control\\Print\\Printers", "System\\CurrentControlSet\\Services\\Eventlog", "Software\\Microsoft\\OLAP Server", "Software\\Microsoft\\Windows NT\\CurrentVersion\\Print", "Software\\Microsoft\\Windows NT\\CurrentVersion\\Windows", "System\\CurrentControlSet\\Control\\ContentIndex", "System\\CurrentControlSet\\Control\\Terminal Server", "System\\CurrentControlSet\\Control\\Terminal Server\\UserConfig", "System\\CurrentControlSet\\Control\\Terminal Server\\DefaultUserConfiguration", "Software\\Microsoft\\Windows NT\\CurrentVersion\\Perflib", "System\\CurrentControlSet\\Services\\SysmonLog"].map(&:downcase)
  wins_server_path = ["System\\CurrentControlSet\\Services\\WINS"].map(&:downcase)
  active_directory_certificate_services_path = ["System\\CurrentControlSet\\Services\\CertSvc"].map(&:downcase)
  reg_values = registry_key("HKEY_LOCAL_MACHINE\\System\\CurrentControlSet\\Control\\SecurePipeServers\\Winreg\\AllowedPaths").Machine.map(&:downcase)
  unless reg_values.nil?
    describe.one do
      describe(reg_values.sort) do
        it { should eq expected.sort }
      ...
      describe(reg_values.sort) do
        it { should eq (expected + wins_server_path).sort }
      end
      describe(reg_values.sort) do
        it { should eq (expected + active_directory_certificate_services_path).sort }
      end
      describe(reg_values.sort) do
        it { should eq (expected + wins_server_path + active_directory_certificate_services_path).sort }
      end
    end
  else
    describe reg_values do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.10.10_L1_Ensure_Network_access_Restrict_anonymous_access_to_Named_Pipes_and_Shares_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.10.11_L1_Ensure_Network_access_Restrict_clients_allowed_to_make_remote_calls_to_SAM_is_set_to_Administrators_Remote_Access_Allow_MS_only" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.10.12_L1_Ensure_Network_access_Shares_that_can_be_accessed_anonymously_is_set_to_None" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.10.13_L1_Ensure_Network_access_Sharing_and_security_model_for_local_accounts_is_set_to_Classic_-_local_users_authenticate_as_themselves" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.11.4_L1_Ensure_Network_security_Configure_encryption_types_allowed_for_Kerberos_is_set_to_AES128_HMAC_SHA1_AES256_HMAC_SHA1_Future_encryption_types" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.17.2_L1_Ensure_User_Account_Control_Behavior_of_the_elevation_prompt_for_administrators_in_Admin_Approval_Mode_is_set_to_Prompt_for_consent_on_the_secure_desktop" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.17.3_L1_Ensure_User_Account_Control_Behavior_of_the_elevation_prompt_for_standard_users_is_set_to_Automatically_deny_elevation_requests" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.17.4_L1_Ensure_User_Account_Control_Detect_application_installations_and_prompt_for_elevation_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.17.5_L1_Ensure_User_Account_Control_Only_elevate_UIAccess_applications_that_are_installed_in_secure_locations_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.17.6_L1_Ensure_User_Account_Control_Run_all_administrators_in_Admin_Approval_Mode_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.17.7_L1_Ensure_User_Account_Control_Switch_to_the_secure_desktop_when_prompting_for_elevation_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_2.3.17.8_L1_Ensure_User_Account_Control_Virtualize_file_and_registry_write_failures_to_per-user_locations_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_9.1.5_L1_Ensure_Windows_Firewall_Domain_Logging_Name_is_set_to_SystemRootSystem32logfilesfirewalldomainfw.log" do
...
control "xccdf_org.cisecurity.benchmarks_rule_9.1.6_L1_Ensure_Windows_Firewall_Domain_Logging_Size_limit_KB_is_set_to_16384_KB_or_greater" do
...
control "xccdf_org.cisecurity.benchmarks_rule_9.1.7_L1_Ensure_Windows_Firewall_Domain_Logging_Log_dropped_packets_is_set_to_Yes" do
...
control "xccdf_org.cisecurity.benchmarks_rule_9.1.8_L1_Ensure_Windows_Firewall_Domain_Logging_Log_successful_connections_is_set_to_Yes" do
...
control "xccdf_org.cisecurity.benchmarks_rule_9.2.5_L1_Ensure_Windows_Firewall_Private_Logging_Name_is_set_to_SystemRootSystem32logfilesfirewallprivatefw.log" do
...
control "xccdf_org.cisecurity.benchmarks_rule_9.2.6_L1_Ensure_Windows_Firewall_Private_Logging_Size_limit_KB_is_set_to_16384_KB_or_greater" do
...
control "xccdf_org.cisecurity.benchmarks_rule_9.2.7_L1_Ensure_Windows_Firewall_Private_Logging_Log_dropped_packets_is_set_to_Yes" do
...
control "xccdf_org.cisecurity.benchmarks_rule_9.2.8_L1_Ensure_Windows_Firewall_Private_Logging_Log_successful_connections_is_set_to_Yes" do
...
control "xccdf_org.cisecurity.benchmarks_rule_9.3.4_L1_Ensure_Windows_Firewall_Public_Settings_Display_a_notification_is_set_to_No" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.2.5_L1_Ensure_Audit_Security_Group_Management_is_set_to_include_Success" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.3.1_L1_Ensure_Audit_PNP_Activity_is_set_to_include_Success" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.3.2_L1_Ensure_Audit_Process_Creation_is_set_to_include_Success" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.5.1_L1_Ensure_Audit_Account_Lockout_is_set_to_include_Failure" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.5.2_L1_Ensure_Audit_Group_Membership_is_set_to_include_Success" do
  title "(L1) Ensure 'Audit Group Membership' is set to include 'Success'"
  desc  "
...
control "xccdf_org.cisecurity.benchmarks_rule_17.5.3_L1_Ensure_Audit_Logoff_is_set_to_include_Success" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.5.6_L1_Ensure_Audit_Special_Logon_is_set_to_include_Success" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.6.1_L1_Ensure_Audit_Detailed_File_Share_is_set_to_include_Failure" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.6.2_L1_Ensure_Audit_File_Share_is_set_to_Success_and_Failure" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.6.3_L1_Ensure_Audit_Other_Object_Access_Events_is_set_to_Success_and_Failure" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.6.4_L1_Ensure_Audit_Removable_Storage_is_set_to_Success_and_Failure" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.7.1_L1_Ensure_Audit_Audit_Policy_Change_is_set_to_include_Success" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.7.2_L1_Ensure_Audit_Authentication_Policy_Change_is_set_to_include_Success" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.7.3_L1_Ensure_Audit_Authorization_Policy_Change_is_set_to_include_Success" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.7.4_L1_Ensure_Audit_MPSSVC_Rule-Level_Policy_Change_is_set_to_Success_and_Failure" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.7.5_L1_Ensure_Audit_Other_Policy_Change_Events_is_set_to_include_Failure" do
  title "(L1) Ensure 'Audit Other Policy Change Events' is set to include 'Failure'"
  desc  "
...
control "xccdf_org.cisecurity.benchmarks_rule_17.9.3_L1_Ensure_Audit_Security_State_Change_is_set_to_include_Success" do
...
control "xccdf_org.cisecurity.benchmarks_rule_17.9.4_L1_Ensure_Audit_Security_System_Extension_is_set_to_include_Success" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.3.6_L1_Ensure_NetBT_NodeType_configuration_is_set_to_Enabled_P-node_recommended" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.3.7_L1_Ensure_WDigest_Authentication_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.5.19.2.1_L2_Disable_IPv6_Ensure_TCPIP6_Parameter_DisabledComponents_is_set_to_0xff_255" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.8.21.3_L1_Ensure_Configure_registry_policy_processing_Process_even_if_the_Group_Policy_objects_have_not_changed_is_set_to_Enabled_TRUE" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.8.26.1_L1_Ensure_Enumeration_policy_for_external_devices_incompatible_with_Kernel_DMA_Protection_is_set_to_Enabled_Block_All" do
  ...
  desc  "
    ...
    **Note #2** : More information on this feature is available at this link: [Kernel DMA Protection for Thunderbolt&#x2122; 3 (Windows 10) | Microsoft Docs](https://docs.microsoft.com/en-us/windows/security/information-protection/kernel-dma-protection-for-thunderbolt) .
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.14.1_L1_Ensure_Require_pin_for_pairing_is_set_to_Enabled_First_Time_OR_Enabled_Always" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.16.1_L1_Ensure_Allow_Telemetry_is_set_to_Enabled_0_-_Security_Enterprise_Only_or_Enabled_1_-_Basic" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.30.2_L1_Ensure_Turn_off_Data_Execution_Prevention_for_Explorer_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.30.3_L1_Ensure_Turn_off_heap_termination_on_corruption_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.30.4_L1_Ensure_Turn_off_shell_protocol_protected_mode_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.39.2_L2_Ensure_Turn_off_location_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.52.1_L1_Ensure_Prevent_the_usage_of_OneDrive_for_file_storage_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.59.2.2_L1_Ensure_Do_not_allow_passwords_to_be_saved_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.59.3.2.1_L2_Ensure_Restrict_Remote_Desktop_Services_users_to_a_single_Remote_Desktop_Services_session_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.59.3.3.1_L2_Ensure_Do_not_allow_COM_port_redirection_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.59.3.3.2_L1_Ensure_Do_not_allow_drive_redirection_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.59.3.3.3_L2_Ensure_Do_not_allow_LPT_port_redirection_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.59.3.3.4_L2_Ensure_Do_not_allow_supported_Plug_and_Play_device_redirection_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.59.3.9.1_L1_Ensure_Always_prompt_for_password_upon_connection_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.59.3.9.2_L1_Ensure_Require_secure_RPC_communication_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.59.3.9.5_L1_Ensure_Set_client_connection_encryption_level_is_set_to_Enabled_High_Level" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.59.3.10.1_L2_Ensure_Set_time_limit_for_active_but_idle_Remote_Desktop_Services_sessions_is_set_to_Enabled_15_minutes_or_less" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.59.3.10.2_L2_Ensure_Set_time_limit_for_disconnected_sessions_is_set_to_Enabled_1_minute" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.59.3.11.1_L1_Ensure_Do_not_delete_temp_folders_upon_exit_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.59.3.11.2_L1_Ensure_Do_not_use_temporary_folders_per_session_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.60.1_L1_Ensure_Prevent_downloading_of_enclosures_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.61.2_L2_Ensure_Allow_Cloud_Search_is_set_to_Enabled_Disable_Cloud_Search" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.61.3_L1_Ensure_Allow_indexing_of_encrypted_files_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.66.1_L2_Ensure_Turn_off_KMS_Client_Online_AVS_Validation_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.77.3.1_L1_Ensure_Configure_local_setting_override_for_reporting_to_Microsoft_MAPS_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.77.3.2_L2_Ensure_Join_Microsoft_MAPS_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.77.7.1_L1_Ensure_Turn_on_behavior_monitoring_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.77.9.1_L2_Ensure_Configure_Watson_events_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.77.10.1_L1_Ensure_Scan_removable_drives_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.77.10.2_L1_Ensure_Turn_on_e-mail_scanning_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.77.13.1.1_L1_Ensure_Configure_Attack_Surface_Reduction_rules_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.77.13.1.2_L1_Ensure_Configure_Attack_Surface_Reduction_rules_Set_the_state_for_each_ASR_rule_is_configured" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.77.13.3.1_L1_Ensure_Prevent_users_and_apps_from_accessing_dangerous_websites_is_set_to_Enabled_Block" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.77.14_L1_Ensure_Configure_detection_for_potentially_unwanted_applications_is_set_to_Enabled_Block" do
  ...
  desc  "
    ...
    For more information, see this link: [Block potentially unwanted applications with Windows Defender Antivirus | Microsoft Docs](https://docs.microsoft.com/en-us/windows/security/threat-protection/windows-defender-antivirus/detect-block-potentially-unwanted-apps-windows-defender-antivirus)
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.77.15_L1_Ensure_Turn_off_Windows_Defender_AntiVirus_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.84.1_L2_Ensure_Allow_suggested_apps_in_Windows_Ink_Workspace_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.84.2_L1_Ensure_Allow_Windows_Ink_Workspace_is_set_to_Enabled_On_but_disallow_access_above_lock_OR_Disabled_but_not_Enabled_On" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.85.1_L1_Ensure_Allow_user_control_over_installs_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.85.2_L1_Ensure_Always_install_with_elevated_privileges_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.85.3_L2_Ensure_Prevent_Internet_Explorer_security_prompt_for_Windows_Installer_scripts_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.86.1_L1_Ensure_Sign-in_and_lock_last_interactive_user_automatically_after_a_restart_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.95.1_L1_Ensure_Turn_on_PowerShell_Script_Block_Logging_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.95.2_L1_Ensure_Turn_on_PowerShell_Transcription_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.97.1.1_L1_Ensure_Allow_Basic_authentication_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.97.1.2_L1_Ensure_Allow_unencrypted_traffic_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.97.1.3_L1_Ensure_Disallow_Digest_authentication_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.97.2.1_L1_Ensure_Allow_Basic_authentication_is_set_to_Disabled" do
  title "(L1) Ensure 'Allow Basic authentication' is set to 'Disabled'"
  desc  "
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.97.2.2_L2_Ensure_Allow_remote_server_management_through_WinRM_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.97.2.3_L1_Ensure_Allow_unencrypted_traffic_is_set_to_Disabled" do
  title "(L1) Ensure 'Allow unencrypted traffic' is set to 'Disabled'"
  desc  "
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.97.2.4_L1_Ensure_Disallow_WinRM_from_storing_RunAs_credentials_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.98.1_L2_Ensure_Allow_Remote_Shell_Access_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.99.2.1_L1_Ensure_Prevent_users_from_modifying_settings_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.102.1.1_L1_Ensure_Manage_preview_builds_is_set_to_Enabled_Disable_preview_builds" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.102.1.2_L1_Ensure_Select_when_Preview_Builds_and_Feature_Updates_are_received_is_set_to_Enabled_Semi-Annual_Channel_180_or_more_days" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.102.1.3_L1_Ensure_Select_when_Quality_Updates_are_received_is_set_to_Enabled_0_days" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.102.2_L1_Ensure_Configure_Automatic_Updates_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.102.3_L1_Ensure_Configure_Automatic_Updates_Scheduled_install_day_is_set_to_0_-_Every_day" do
...
control "xccdf_org.cisecurity.benchmarks_rule_18.9.102.4_L1_Ensure_No_auto-restart_with_logged_on_users_for_scheduled_automatic_updates_installations_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_19.6.6.1.1_L2_Ensure_Turn_off_Help_Experience_Improvement_Program_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_19.7.7.1_L1_Ensure_Configure_Windows_spotlight_on_lock_screen_is_set_to_Disabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_19.7.7.2_L1_Ensure_Do_not_suggest_third-party_content_in_Windows_spotlight_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_19.7.7.3_L2_Ensure_Do_not_use_diagnostic_data_for_tailored_experiences_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_19.7.7.4_L2_Ensure_Turn_off_all_Windows_spotlight_features_is_set_to_Enabled" do
...
control "xccdf_org.cisecurity.benchmarks_rule_19.7.41.1_L1_Ensure_Always_install_with_elevated_privileges_is_set_to_Disabled" do
  title "(L1) Ensure 'Always install with elevated privileges' is set to 'Disabled'"
  desc  "
    This setting controls whether or not Windows Installer should use system permissions when it installs any program on the system.
...
control "xccdf_org.cisecurity.benchmarks_rule_19.7.45.2.1_L2_Ensure_Prevent_Codec_Download_is_set_to_Enabled" do
