...
run_list 'chef_client::default', 'chef_client::stage_waivers', 'os-hardening::default', 'remediation_cis_rhel8_v_1_0_0::default'

# Specify a custom source for a single cookbook:
# cookbook 'example_cookbook', path: '../cookbooks/example_cookbook'
cookbook 'chef_client', path: '../cookbooks/chef_client'
cookbook 'os-hardening', path: '../cookbooks/os-hardening'
cookbook 'remediation_cis_rhel8_v_1_0_0', path: '../cookbooks/remediation_cis_rhel8_v_1_0_0'
...
# InSpec waiver file
default['audit']['waiver_file'] = '/tmp/waivers.yaml'
